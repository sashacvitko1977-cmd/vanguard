...
export function GlobalVideoBackground() {
  ...
  if (reduced) {
    return (
      <div
        className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[#030308]"
        aria-hidden="true"
      >
        <div
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[#030308]" aria-hidden="true">
      <video
        ref={videoRef}
